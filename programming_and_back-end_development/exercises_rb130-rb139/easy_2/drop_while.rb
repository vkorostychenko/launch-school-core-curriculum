# The Enumerable#drop_while method begins by iterating over the members of
# a collection, passing each element to the associated block until it finds
# an element for which the block returns false or nil. It then converts the
