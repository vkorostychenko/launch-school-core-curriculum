...
# element and an index number to the block. each_with_index should return
# a reference to the original Array.

# Your method may use #each, #each_with_object, #reduce, loop, for, while,
# or until to iterate through the Array passed in as an argument, but must not
