...
argument.
Your program may assume that all programs are correct programs; that
...
minilang('PRINT') # register = 0
# 0

minilang('5 PUSH 3 MULT PRINT') # register = 5 -> register = 3
# 15
...
def minilang(instructions)
  ...
  instructions.split.each do |token|
    case token
