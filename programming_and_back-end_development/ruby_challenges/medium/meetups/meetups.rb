...
# Your object should be able to determine the exact date of the meeting in
# the specified month and year. For instance, if you ask for the 2nd Wednesday of May 2021,
# the object should be able to determine that the meetup for that month will occur
...
# Therefore, it's guaranteed that each day of the week (Monday, Tuesday, ...) will
# have exactly one date that is the "teenth" of that day in every month. That is,
