...
# definition of a Proc and a Lambda, and the differences between the two.
# Run each group of code below: For your answer to this exercise, write down
# your observations for each group of code. After writing out those observations,
...
# This can be seen when displaying a Lambda: the string displayed contains an
# extra "(lambda)" that is not present for regular Procs.
# A lambda enforces the number of arguments. If the expected number of arguments
# are not passed to it, then an error is thrown.
