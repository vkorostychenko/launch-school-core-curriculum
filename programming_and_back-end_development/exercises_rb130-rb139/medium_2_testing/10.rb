...
# One of the useful facets of the setup and teardown methods is that they are
# automatically run before and after each test respectively. To show this we'll
